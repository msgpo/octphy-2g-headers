...
#if defined( _OCT_ENDIAN_TYPE_LE_ )
#define mOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING_SWAP( _f_pParms ){ 	tOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING * pOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING = (_f_pParms); SWAP_UNUSED(pOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING)\
	((tOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING *)pOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING)->ulAntennaIndex = \
		mOCT_SWAP32_IF_LE(((tOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING *)pOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING)->ulAntennaIndex); \
	((tOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING *)pOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING)->ulRxLogicalAntennaId = \
		mOCT_SWAP32_IF_LE(((tOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING *)pOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING)->ulRxLogicalAntennaId); \
	((tOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING *)pOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING)->ulTxLogicalAntennaId = \
		mOCT_SWAP32_IF_LE(((tOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING *)pOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING)->ulTxLogicalAntennaId); \
}
#else
#define mOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING_SWAP( pOCTVC1_HW_RF_PORT_ANTENNA_PHYSICAL_MAPPING )
#endif /* _OCT_ENDIAN_TYPE_LE_ */
